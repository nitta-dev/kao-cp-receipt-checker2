...
## 抽出項目
- store_name: 店舗チェーン名
  - レシート最上部に大きく印字されている店舗ブランド名を記載
  - ★レシートに印字されている文字のみ使用。
  - ★住所・電話番号に含まれる地名を店舗名にしない
  - ★推測で別の店舗名を書かない
  - 例: 「ツルハドラッグ」「マツモトキヨシ」「ウエルシア薬局」「ビッグ・エー」「ドン・キホーテ」
- store_branch: 支店名（店舗名の直後または直下に記載される「○○店」「○○駅前店」等）
  - ★レシートに印字されている通りに記載。住所から支店名を推測しない
